...
__Vectors       DCD     __initial_sp              ; Top of Stack
				...
				DCD     PORTA_IRQHandler           ; 83
				DCD     PORTB_IRQHandler           ; 84
				DCD     PORTC_IRQHandler           ; 85
				DCD     PORTD_IRQHandler           ; 86
				DCD     0                          ; 87  Reserved 
				DCD     0                          ; 88  Reserved         
				...
				DCD     SSP0_TBSYINTR_IRQHandler   ; 99        
				...
				DCD     SSP1_TBSYINTR_IRQHandler   ; 107
				DCD     UART0_IRQHandler           ; 108
				DCD     UART0_TBSYINTR_IRQHandler  ; 109
				...
				DCD     UART1_TBSYINTR_IRQHandler  ; 118
				...
				DCD     UART2_TBSYINTR_IRQHandler  ; 127
				...
				DCD     UART3_TBSYINTR_IRQHandler  ; 136
				...
				DCD     TMR0_IRQHandler            ; 154  
				DCD     TMR1_IRQHandler            ; 155  
				DCD     TMR2_IRQHandler            ; 156  
				DCD     TMR3_IRQHandler            ; 157          
...
PVD_IF_IRQHandler PROC
                EXPORT  PVD_IF_IRQHandler			[WEAK]
				B       .
				ENDP
...
SSP0_TBSYINTR_IRQHandler PROC
                EXPORT  SSP0_TBSYINTR_IRQHandler			[WEAK]
				B       .
				ENDP
...
SSP1_TBSYINTR_IRQHandler PROC
                EXPORT  SSP1_TBSYINTR_IRQHandler			[WEAK]
				B       .
				ENDP
...
UART0_TBSYINTR_IRQHandler PROC
                EXPORT  UART0_TBSYINTR_IRQHandler			[WEAK]
				B       .
				ENDP
...
UART1_TBSYINTR_IRQHandler PROC
                EXPORT  UART1_TBSYINTR_IRQHandler			[WEAK]
				B       .
				ENDP
...
UART2_TBSYINTR_IRQHandler PROC
                EXPORT  UART2_TBSYINTR_IRQHandler			[WEAK]
				B       .
				ENDP
...
UART3_TBSYINTR_IRQHandler PROC
                EXPORT  UART3_TBSYINTR_IRQHandler			[WEAK]
				B       .
				ENDP
...
CRCD_IRQHandler PROC
                EXPORT  CRCD_IRQHandler			[WEAK]
				B       .
				ENDP
